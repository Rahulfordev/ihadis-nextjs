        ...
        <div className="w-full h-[50px] category-bar">
          ...
          <div className="pl-4 cat-scrl pb-10 xl:pb-0 lg-max-h lg:h-[calc(100vh_-_270px)] pr-1.5 mr-1.5 mt-4">
            <div className="flex gap-y-2 flex-col w-full">
              ...
              <div className="p-4 flex cursor-pointer hover:bg-[#ebfcf6] bg-white justify-between items-center rounded-2xl h-[6.25rem]">
                <div className="flex items-center gap-4">
                  <div className="h-12 w-12 xl:w-10  flex items-center justify-center relative">
                    <h3 className="text-white absolute text-xl font-medium group-hover:opacity-100 xl:text-lg">
                      ২
                    </h3>
                    <svg
                      className="fill hover:fill-[#096e55]"
                      width="56"
                      height="62"
                      viewBox="0 0 56 62"
                      fill="none"
