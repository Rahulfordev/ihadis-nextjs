...
import breadCrumbBook from "../../../public/assets/others/bread-crumb-book.svg";
import forword from "../../../public/assets/others/forword.svg";
import book from "../../../public/assets/others/book.svg";
import copy from "../../../public/assets/others/copy.svg";
import bookmark from "../../../public/assets/others/bookmark.svg";
import share from "../../../public/assets/others/share.svg";
import report from "../../../public/assets/others/report.svg";
import direct from "../../../public/assets/others/direct.svg";

const HadisContent = () => {
  return (
    <div className="xs-col-span-3 sm-col-span-3 md-col-span-3 lg:w-[101%] xl:min-w-[101.5%] sm-pb-24 lg:pb-12 cat-scrl 2xl:w-full lg:h-[calc(100vh_-_80px)]">
      <div className="hidden lg-max-full lg-max-block lg-max:col-span-full xss:pt-0 ">
        <div className="flex flex-row justify-between p-4 bg-white rounded-2xl items-center cursor-pointer xl:hidden ">
          <p class="flex gap-x-2 text-title font-medium leading-[25px] dark:text-dark-text text-mss ">
            <svg
      ...
      <div className="hidden xl:block">
        <div
          className="h-14 px-5 py-4 gap-2 flex w-full items-center 
    bg-[#FAFBFB] rounded-t-xl text-[#667085] text-sm border-b-2 border-b-[#ECEEF0] 
     cursor-pointer
    lg-max:hidden"
        >
          <div className="flex flex-row">
            <div>
              <Image src={breadCrumbBook} alt="breadCrumbBook" />
            </div>
            <div className="flex flex-row">
      ...
      <div className="lg-max-hidden h-26 px-5 py-6 bg-white rounded-b-xl md-rounded-xl sm-ptb">
        <div class="flex justify-center items-center gap-x-6">
          ...
          <div className="flex justify-between items-center gap-2 w-full">
            <div className="">
              <h3 className="mb-1 xss-text-15 xs-text-15 sm-text-15">
                সহিহ বুখারী
              </h3>
              <div className="text-sm xss-text-xs xs-text-xs sm:text-xs">
                সর্বমোট হাদিস - <span>৭৫৬৩</span>
              </div>
            </div>
            <h3 className="sm-hidden font-me_quran text-2xl xss-text-xl xs-text-2xl">
              صحيح البخاري
            </h3>
          </div>
        </div>
      ...
      <div>
        <div style={{ opacity: 1, transform: "none" }}>
          <div class="flex items-center gap-x-4 bg-white rounded-xl px-5 py-5 w-full my-4 sm-px-4">
            <div class="flex items-center justify-center text-white w-[42.34px] h-10 rounded-xl bg-d-color font-medium leading-6 xss-w-10 xss-h-9 xss:text-sm xss-rounded-lg xs-w-10 xs-h-9 xs:text-sm xs-rounded-lg">
              ১
            </div>
            <div class="flex items-center justify-between w-full">
              <div class="style-Kalpurush-webKit text-xl leading-7 text-offgrey-text-color dark:text-hadith-deepoffwhite xs-max:w-full sm-min:w-8/12">
                ওহীর সূচনা অধ্যায়
              </div>
            </div>
          </div>
        ...
        <div>
            ...
            <div className="bg-white my-4 p-5 rounded-xl">
              <div className="flex justify-between">
                <div className="grid gap-x-3 gap-y-4 grid-cols-[32px,1fr] 2xl:grid-rows-1">
                  <Image className="w-8" src={book} alt="book" />
                  <h3 className="flex items-center text-base md:text-[17px] font-semibold leading-5">
                    ১/১. অধ্যায়ঃ
                  </h3>
                  <div
                    className="text-[15px] md:text-base leading-[24px] col-span-2"
              ...
              <div className="h-full transition-all duration-1000 delay-1000">
                <div className="w-full h-[1px] bg-[#ECEEF0] my-5 transition-all duration-150 delay-150"></div>
                <div
                  className="block text-base leading-8 text-[#373737]"
                  style={{ lineHeight: 1.8, fontSize: "17px" }}
                >
                  <span>
          ...
          <div style={{ opacity: 1, transform: "none" }}>
            <div class="my-4">
              <div>
                <div className="flex justify-between items-center gap-x-3 px-4 pt-8 bg-white rounded-t-xl">
                  <div className="flex items-center gap-x-3">
                    ...
                    <div className="text-color-green text-xl leading-6 text-primary">
                      ১
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-b-xl p-6">
                ...
                >
                  <p>
                    ...
                    الْخَطَّابِ ـ رضى الله عنه ـ عَلَى الْمِنْبَرِ قَالَ
                    سَمِعْتُ رَسُولَ اللَّهِ صلى الله عليه وسلم يَقُولُ ‏ "‏
                    إِنَّمَا الأَعْمَالُ بِالنِّيَّاتِ، وَإِنَّمَا لِكُلِّ
                    امْرِئٍ مَا نَوَى، فَمَنْ كَانَتْ هِجْرَتُهُ إِلَى دُنْيَا
                    يُصِيبُهَا أَوْ إِلَى امْرَأَةٍ يَنْكِحُهَا فَهِجْرَتُهُ
                    إِلَى مَا هَاجَرَ إِلَيْهِ
                  </p>
                </div>
                <p
                  className="text-color-green text-primary leading-5"
                  style={{ lineHeight: "1.8", fontSize: "17px" }}
                >
                  ‘আলক্বামাহ ইব্‌নু ওয়াক্কাস আল-লায়সী (রহঃ) থেকে বর্ণিত:
                </p>
                <p
                  className="mt-4 leading-10"
                  style={{ lineHeight: "1.8", fontSize: "17px" }}
                >
                  <span>
                    আমি ‘উমর ইব্‌নুল খাত্তাব (রাঃ)-কে মিম্বারের উপর দাঁড়িয়ে বলতে
                    শুনেছিঃ আমি আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি ওয়া
                    সাল্লাম)-কে বলতে শুনেছিঃ কাজ (এর প্রাপ্য হবে) নিয়ত অনুযায়ী।
                    আর মানুষ তার নিয়ত অনুযায়ী প্রতিফল পাবে। তাই যার হিজরত হবে
                    ইহকাল লাভের অথবা কোন মহিলাকে বিবাহ করার উদ্দেশ্যে- তবে তার
                    হিজরত সে উদ্দেশ্যেই হবে, যে জন্যে, সে হিজরত করেছে। (৫৪,
                    ২৫২৯, ৩৮৯৮, ৫০৭০, ৬৬৮৯, ৬৯৫৩; মুসলিম ২৩/৪৫ হাঃ ১৯০৭, আহমাদ
                    ১৬৮) ( আধুনিক প্রকাশনী- ১, ইসলামিক ফাউন্ডেশন ১)
                  </span>
                </p>
                <div className="hidden mt-8 ">
                  <div className="flex items-center gap-2 mt-4">
                    <div className="text-base leading-[18.15px]">
                      হাদিসের মান :
                    </div>
                    <button
                      className="pt-1.5 pb-1 rounded-[.3rem] text-white px-3 flex items-center justify-center font-medium text-sm"
                ...
                <div className="justify-center lg:justify-between mt-10 flex items-center">
                  <div className="hidden lg:block">
                    <div className="flex items-center gap-2">
                      <div className="text-base leading-[18.15px]">
                        হাদিসের মান :
                      </div>
                      <button className="pt-1.5 pb-1 rounded-[.3rem] bg-d-color text-white px-3 flex items-center justify-center font-medium text-sm">
                        <p>সহিহ হাদিস</p>
                      </button>
                    </div>
                  </div>
                  <div className="flex items-center gap-10">
                    <div className="relative w-6 group">
                      ...
                      <div class="absolute -top-10 -left-3 invisible group-hover:visible">
                        <div class="relative">
                          <p class="bg-gray-700 text-sm px-2 py-1 rounded-md text-white">
                            কপি
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative w-6 group">
                      <Image
                        ...
                        alt="bookmark"
                      />
                      <div class="absolute -top-10 -left-5 invisible group-hover:visible">
                        <div class="relative">
                          <p class="bg-gray-700 text-sm px-2 py-1 rounded-md text-white">
                            বুকমার্ক
                          </p>
                    ...
                    <div className="relative w-6 group">
                      <Image
                        ...
                        alt="share"
                      />
                      <div class="absolute -top-10 -left-4 invisible group-hover:visible">
                        <div class="relative">
                          <p class="bg-gray-700 text-sm px-2 py-1 rounded-md text-white">
                            শেয়ার
                          </p>
          ...
          <div style={{ opacity: 1, transform: "none" }}>
            <div className="bg-white my-4 p-5 rounded-xl">
              <div class="flex justify-between">
                <div className="grid gap-x-3 gap-y-4 grid-cols-[32px,1fr] 2xl:grid-rows-1">
                  <Image class="w-8" src={book} alt="book" />
                  <h3 className="flex items-center text-[17px] font-semibold leading-5">
                    ১/২. অধ্যায়ঃ
                  </h3>
                  <div
                    className="text-base leading-[24px] col-span-2"
                    style={{ lineHeight: 1.8, fontSize: "17px" }}
                  >
                    <span>১/২. অধ্যায়ঃ</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-b-xl p-6">
                ...
                >
                  <p>
                    ...
                    عَائِشَةَ أُمِّ الْمُؤْمِنِينَ ـ رضى الله عنها ـ أَنَّ
                    الْحَارِثَ بْنَ هِشَامٍ ـ رضى الله عنه ـ سَأَلَ رَسُولَ
                    اللَّهِ صلى الله عليه وسلم فَقَالَ يَا رَسُولَ اللَّهِ
                    كَيْفَ يَأْتِيكَ الْوَحْىُ فَقَالَ رَسُولُ اللَّهِ صلى الله
                    عليه وسلم ‏ "‏ أَحْيَانًا يَأْتِينِي مِثْلَ صَلْصَلَةِ
                    الْجَرَسِ ـ وَهُوَ أَشَدُّهُ عَلَىَّ ـ فَيُفْصَمُ عَنِّي
                    وَقَدْ وَعَيْتُ عَنْهُ مَا قَالَ، وَأَحْيَانًا يَتَمَثَّلُ
                    لِيَ الْمَلَكُ رَجُلاً فَيُكَلِّمُنِي فَأَعِي مَا يَقُولُ
                    ‏"‏‏.‏ قَالَتْ عَائِشَةُ رضى الله عنها وَلَقَدْ رَأَيْتُهُ
                    يَنْزِلُ عَلَيْهِ الْوَحْىُ فِي الْيَوْمِ الشَّدِيدِ
                ...
                >
                  <span>
                    হারিস ইব্‌নু হিশাম (রাঃ) আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি
                    ওয়া সাল্লাম)- কে জিজ্ঞেস করলেন, ‘হে আল্লাহর রসূল! আপনার নিকট
                    ওয়াহী কিরূপে আসে?’ আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি ওয়া
                    সাল্লাম) বললেনঃ [কোন কোন সময় তা ঘন্টা বাজার মত আমার নিকট
                    আসে। আর এটি-ই আমার উপর সবচেয়ে বেদনাদায়ক হয় এবং তা শেষ হতেই
                    মালাক (ফেরেশতা) যা বলেন তা আমি মুখস্ত করে নেই, আবার কখনো
                    মালাক মানুষের রূপ ধারণ করে আমার সাথে কথা বলেন। তিনি যা বলেন
                    আমি তা মুখস্ত করে নেই।] ‘আয়িশা (রাঃ) বলেন, আমি তীব্র শীতের
                    সময় ওয়াহী নাযিলরত অবস্থায় তাঁকে দেখেছি। ওয়াহী শেষ হলেই তাঁর
                    ললাট হতে ঘাম ঝরে পড়ত। (৩২১৫; মুসলিম ৪৩/২৩, হাঃ ২৩৩৩, আহমাদ
                    ২৫৩০৭, ২৬২৫৮) (আধুনিক প্রকাশনীঃ ২, ইসলামী ফাউন্ডেশনঃ ২)
                  </span>
                </p>
                <div className="hidden mt-8 ">
                  <div className="flex items-center gap-2 mt-4">
          ...
          <div style={{ opacity: 1, transform: "none" }}>
            <div class="my-4">
              ...
              <div className="bg-white rounded-b-xl p-6">
                ...
                >
                  <span>
                    তিনি বলেন, আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম)-
                    এর নিকট সর্বপ্রথম যে ওয়াহী আসে, তা ছিল নিদ্রাবস্থায় বাস্তব
                    স্বপ্নরূপে। যে স্বপ্নই তিনি দেখতেন তা একেবারে প্রভাতের আলোর
                    ন্যায় প্রকাশিত হতো। অতঃপর তাঁর নিকট নির্জনতা পছন্দনীয় হয়ে
                    দাঁড়ায় এবং তিনি ‘হেরা’র গুহায় নির্জনে অবস্থান করতেন। আপন
                    পরিবারের নিকট ফিরে এসে কিছু খাদ্যসামগ্রী সঙ্গে নিয়ে যাওয়ার
                    পূর্বে- এভাবে সেখানে তিনি এক নাগাড়ে বেশ কয়েক দিন ‘ইবাদাতে
                    মগ্ন থাকতেন। অতঃপর খাদীজা (রাঃ)-এর নিকট ফিরে এসে আবার একই
                    সময়ের জন্য কিছু খাদ্যদ্রব্য নিয়ে যেতেন। এভাবে ‘হেরা’ গুহায়
                    অবস্থানকালে তাঁর নিকট ওয়াহী আসলো। তাঁর নিকট ফেরেশতা এসে
                    বললো, ‘পাঠ করুন’। আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি ওয়া
                    সাল্লাম) বলেনঃ [“আমি বললাম, ‘আমি পড়তে জানি না।] তিনি
                    (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম) বলেনঃ অতঃপর সে আমাকে
                    জড়িয়ে ধরে এমন ভাবে চাপ দিলো যে, আমার খুব কষ্ট হলো। অতঃপর সে
                    আমাকে ছেড়ে দিয়ে বললো, ‘পাঠ করুন’। আমি বললামঃ আমি তো পড়তে
                    জানি না’। সে দ্বিতীয় বার আমাকে জড়িয়ে ধরে এমনভাবে চাপ দিলো
                    যে, আমার খুব কষ্ট হলো। অতঃপর সে আমাকে ছেড়ে দিয়ে বললো, ‘পাঠ
                    করুন’। আমি উত্তর দিলাম, ‘আমি তো পড়তে জানি না’। আল্লাহর রসূল
                    (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম) বলেন, অতঃপর তৃতীয়বারে
                    তিনি আমাকে জড়িয়ে ধরে চাপ দিলেন। তারপর ছেড়ে দিয়ে বললেন, “পাঠ
                    করুন আপনার রবের নামে, যিনি সৃষ্টি করেছেন। যিনি সৃষ্টি করেছেন
                    মানুষকে জমাট রক্ত পিন্ড থেকে, পাঠ করুন, আর আপনার রব অতিশয়
                    দয়ালু”- (সূরা আলাক্ব ৯৬/১-৩)। অতঃপর এ আয়াত নিয়ে আল্লাহর রসূল
                    (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম)- প্রত্যাবর্তন করলেন। তাঁর
                    হৃদয় তখন কাঁপছিল। তিনি খাদীজা বিন্‌তু খুওয়ায়লিদের নিকট এসে
                    বললেন, ‘আমাকে চাদর দ্বারা আবৃত কর’, ‘আমাকে চাদর দ্বারা আবৃত
                    কর’। তাঁরা তাঁকে চাদর দ্বারা আবৃত করলেন। এমনকি তাঁর শংকা দূর
                    হলো। তখন তিনি খাদীজা (রাঃ) এর নিকট ঘটনাবৃত্তান্ত জানিয়ে
                    তাঁকে বললেন, আমি আমার নিজেকে নিয়ে শংকা বোধ করছি। খাদীজা
                    (রাঃ) বললেন, আল্লাহর কসম, কখনই নয়। আল্লাহ আপনাকে কখনো
                    লাঞ্ছিত করবেন না। আপনি তো আত্মীয়–স্বজনের সঙ্গে সদাচরণ করেন,
                    অসহায় দুস্থদের দায়িত্ব বহন করেন, নিঃস্বকে সহযোগিতা করেন,
                    মেহমানের আপ্যায়ন করেন এবং হক পথের দুর্দশাগ্রস্থকে সাহায্য
                    করেন। অতঃপর তাঁকে নিয়ে খাদীজা (রাঃ) তাঁর চাচাত ভাই ওয়ারাকাহ
                    ইব্‌নু নাওফাল ইব্‌নু ‘আবদুল আসাদ ইব্‌নু ‘আবদুল ‘উযযাহ’র নিকট
                    গেলেন, যিনি অন্ধকার যুগে ‘ঈসায়ী ধর্ম গ্রহন করেছিলেন। যিনি
                    ইবরানী ভাষায় লিখতে পারতেন এবং আল্লাহর তাওফীক অনুযায়ী ইবরানী
                    ভাষায় ইনজীল হতে ভাষান্তর করতেন। তিনি ছিলেন অতি বৃদ্ধ এবং
                    অন্ধ হয়ে গিয়েছিলেন। খাদীজা (রাঃ) তাঁকে বললেন, ‘হে চাচাত ভাই!
                    আপনার ভাতিজার কথা শুনুন’। ওয়ারাকাহ তাঁকে জিজ্ঞেস করলেন,
                    ‘ভাতিজা! তুমি কী দেখ?’ আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি
                    ওয়া সাল্লাম) যা দেখেছিলেন, সবই বর্ণনা করলেন। তখন ওয়ারাকাহ
                    তাঁকে বললেন, এটা সেই বার্তাবাহক যাকে আল্লাহ মূসা (‘আঃ)- এর
                    নিকট পাঠিয়েছিলেন। আফসোস! আমি যদি সেদিন যুবক থাকতাম। আফসোস !
                    আমি যদি সেদিন জীবিত থাকতাম, যেদিন তোমার কওম তোমাকে বহিষ্কার
                    করবে’। আল্লাহর রসূল (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম)
                    বললেন, [‘তারা কি আমাকে বের করে দেবে?’] তিনি বললেন, ‘হ্যাঁ,
                    তুমি যা নিয়ে এসেছো অনুরূপ (ওয়াহী) কিছু যিনিই নিয়ে এসেছেন
                    তাঁর সঙ্গেই বৈরিতাপূর্ণ আচরণ করা হয়েছে। সেদিন যদি আমি থাকি,
                    তবে তোমাকে জোরালোভাবে সাহায্য করব। এর কিছুদিন পর ওয়ারাকাহ
                    (‘আঃ) ইন্তিকাল করেন। আর ওয়াহীর বিরতি ঘটে।(৩৩৯২, ৪৯৫৩, ৪৯৫৫,
                    ৪৯৫৬, ৪৯৫৭, ৬৯৮২; মুসলিম ১/৭৩ হাঃ ১৬০, আহমাদ ২৬০১৮) (আধুনিক
                    প্রকাশনীঃ ৩, ইসলামী ফাউন্ডেশনঃ ৩)
                  </span>
                </p>
                <div className="hidden mt-8 ">
                  <div className="flex items-center gap-2 mt-4">
